...
class TindakanDataTable extends DataTable
{
    ...
    {
        return $model->newQuery()->with(['layanan']);
    }
        ...
        return $this->builder()
                    ...
                    ->parameters([
                        ...
                        'drawCallback' => 'function() {
                            $("#tindakan-table thead").addClass("bg-biru")
                            $("#tindakan-table thead tr th").addClass("text-white bg-biru")
                            $("#tindakan-table tbody tr").addClass("border-b odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600")
                        }',
                        'select' => false
                    ]);
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::computed('layanan.nama_layanan')->title('Nama Layanan')->label('Nama Layanan')->orderable(true),
            Column::computed('kode_tindakan')->title('Kode Tindakan')->label('Kode Tindakan')->orderable(true),
            Column::computed('nama_tindakan')->title('Nama Tindakan')->label('Nama Tindakan')->orderable(true),
