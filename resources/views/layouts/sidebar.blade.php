        ...
        <ul>
            ...
            @if (Auth::user()->role == "admin")
                ...
                <li class="relative px-6 py-3">
                    ...
                    @endif
                    <a
                        class="inline-flex items-center w-full text-sm font-semibold @if (getFirstUrl() == "instalasi") text-gray-800 @endif transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                        href="/instalasi"
                    >
                        <svg
                            class="w-5 h-5"
                        ...
                        <span class="ml-4">Instalasi</span>
                    </a>
                </li>
                <li class="relative px-6 py-3">
                    @if (getFirstUrl() == "layanan")
                        <span
                            class="absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg"
                            aria-hidden="true"
                        ></span>
                    @endif
                    <a
                        class="inline-flex items-center w-full text-sm font-semibold @if (getFirstUrl() == "layanan") text-gray-800 @endif transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                        href="/layanan"
                    >
                        <svg
                            class="w-5 h-5"
                ...
                <li class="relative px-6 py-3">
                    ...
                    @endif
                    <a
                        class="inline-flex items-center w-full text-sm font-semibold @if (getFirstUrl() == "tindakan") text-gray-800 @endif transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                        href="/tindakan"
                    >
                        <svg
                            class="w-5 h-5"
